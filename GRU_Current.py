...
units_test = [[16],[16,16,16],[16,16,16,16,16],[16,16,16,16,16,16,16], [128],[128,128,128],[128,128,128,128,128],[128,128,128,128,128,128,128]]
...
for num_units in units_test: 
    ...
    if len(num_units) == 1:
        ...
        model.add(layers.CuDNNGRU(num_units[0],
        ...
        for i in range(1,len(num_units) - 1):
            model.add(layers.CuDNNGRU(num_units[i],
                                 return_sequences=True))
        
        
        model.add(layers.CuDNNGRU(num_units[-1]))
