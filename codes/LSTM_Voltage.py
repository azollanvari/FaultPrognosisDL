...
units_test = [[64,64,64],[64,64,64,64,64]]
...
for num_units in units: 
    ...
    if len(num_units) == 1:
        ...
        model.add(layers.CuDNNLSTM(num_units[0],
        ...
        for i in range(1,len(num_units) - 1):
            model.add(layers.CuDNNLSTM(num_units[i],
                                 return_sequences=True))
        
        
        model.add(layers.CuDNNLSTM(num_units[-1]))
